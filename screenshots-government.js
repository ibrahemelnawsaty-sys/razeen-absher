...
const pages = [
  ...
  { name: '02-reports-management', url: '/government/reports', waitFor: 2000 },
  { name: '03-centers-management', url: '/government/centers', waitFor: 2000 },
  { name: '04-analytics', url: '/government/analytics', waitFor: 3000 },
  { name: '05-map', url: '/map', waitFor: 4000 },
  { name: '06-profile', url: '/profile', waitFor: 2000 },
];

async function takeScreenshots() {
  console.log('🚀 بدء التقاط صور الجهة الحكومية...\n');
  ...
  const screenshotsDir = path.join(__dirname, 'screenshots', 'government');
  ...
  await browser.close();
  console.log('\n✨ انتهى! الصور في: screenshots/government/');
}
